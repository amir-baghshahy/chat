...
export function CallHistoryModal() {
  ...
  return (
    ...
    >
      <div
        className="bg-[color:var(--tg-bg)] rounded-xl w-[90%] max-w-[600px] max-h-[80vh] flex flex-col shadow-[0_8px_32px_var(--tg-shadow)] overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="px-5 py-4 flex items-center justify-between border-b border-[color:var(--tg-border)]">
          <h2 className="text-[18px] font-semibold">Call History</h2>
          <button
            ...
            {callHistoryData.map(call => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[15px] font-medium text-[color:var(--tg-text-primary)] mb-1">{call.name}</div>
                  <div className="flex items-center gap-2 text-[13px] text-[color:var(--tg-text-secondary)]">
                    <i
                ...
                <div className="text-[14px] text-[color:var(--tg-text-secondary)] px-2 py-1 bg-[color:var(--tg-bg-secondary)] rounded">
                  {call.duration}
                </div>
