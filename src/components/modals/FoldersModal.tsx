...
export function FoldersModal() {
  ...
  return (
    ...
    >
      <div
        className="modal-content bg-[color:var(--tg-bg-secondary)] rounded-lg w-[90%] max-w-[450px] max-h-[80vh] flex flex-col shadow-[0_8px_32px_var(--tg-shadow)] overflow-hidden"
